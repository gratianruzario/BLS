...
namespace LibraryDesign_frontEndUI.Library
{
    class DbBackUpHelper
    {
        ...
        public void BackUpDatabase(string strBackUpLocation, string strDatabaseName)
        {
            try
            {
                ...
                sqlcmd = new SqlCommand("backup database " + strDatabaseName + " to disk='" + strBackUpLocation + ".Bak'", sqlcon);
